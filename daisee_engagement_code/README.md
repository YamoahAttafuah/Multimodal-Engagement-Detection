...
-   **daisee_model_training.py**\
    The script written to train and evaluate the DAiSEE model

-   **preprocessing_and_feature_extraction.py**\
    The script used to preprocess, split, and extract features from the clips of the DAiSEE dataset.
...
1. Install **Python 3.9** alongside your current version of Python.
2. Create a virtual environment using **Python 3.9** and activate it.
