...
# Function to determine top 2 active states
...
def draw_overlay(frame, active_states):
    if active_states:
        ...
        for s in active_states:
            ...
            display_items.append(f"{label.upper()} ({norm_val:.2f})")
            
        status_msg = " | ".join(display_items)

        primary_label = active_states[0]["label"]
        color = COLORS.get(primary_label, (200, 200, 200))
